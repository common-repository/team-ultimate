<?php
	...
	if($pe_team_types == 1){
		...
		<style type="text/css">
			...
			.teamultimate-<?php echo $postid;?> .single-teamultimate-items-<?php echo $postid;?> {
				display: block;
				overflow: hidden;
				margin-bottom: 0px;
			...
			.teamultimate-<?php echo $postid;?> .single-teamultimate-info {
			    padding: 15px;
			    text-align: center;
			}
			.teamultimate-<?php echo $postid;?> .single-teamultimate-title h2 {
			    margin: 0;
			    padding: 0;
			...
			.teamultimate-<?php echo $postid;?> .single-teamultimate-designation h3 {
			    margin: 0;
			    padding: 0;
			...
			.teamultimate-<?php echo $postid;?> .single-teamultimate-email h4 {
			    margin: 0;
			    padding: 0;
			...
			.teamultimate-<?php echo $postid;?> .single-teamultimate-numbers p {
			    margin: 0;
			    padding: 0;
			...
			.teamultimate-<?php echo $postid;?> .single-teamultimate-description p {
			    margin: 0;
			    padding: 0;
			...
			.teamultimate-<?php echo $postid;?> .single-teamultimate-location p {
			    margin: 0;
			    padding: 0;
			...
			.teamultimate-<?php echo $postid;?> .single-teamultimate-socialprofiles {
			    margin-top: 15px;
			}
			.teamultimate-<?php echo $postid;?> .single-teamultimate-socialprofiles ul {
			    margin: 0;
			    padding: 0;
			    list-style: none;
			}
			.teamultimate-<?php echo $postid;?> .single-teamultimate-socialprofiles ul li a {
			...
			.teamultimate-<?php echo $postid;?> .single-teamultimate-socialprofiles ul li a:visited {
			    color: <?php echo $pe_team_socialicon_color;?>;
			    text-decoration: none;
			    box-shadow: none;
			    outline: none;
			...
			.teamultimate-<?php echo $postid;?> .single-teamultimate-thumb img {
			    box-shadow: none;
			    border-radius: 0;
			...
			<?php if( $pe_team_social_style == 1 ){ ?>
				.teamultimate-<?php echo $postid;?> .single-teamultimate-socialprofiles ul li {
				    list-style: none;
