<?php
	...
	if($pe_team_types == 1){
		...
		<style type="text/css">
			.teamultimate-four-<?php echo $postid;?> {
				display: flex;
				flex-wrap: wrap;
				position: relative;
			}
			.teamultimate-four-<?php echo $postid;?> .single-teamultimate-items-<?php echo $postid;?> {
				display: block;
				overflow: hidden;
				margin-bottom: 0px;
			...
			.teamultimate-four-<?php echo $postid;?> .single-teamultimate-items-<?php echo $postid;?>::before {
			...
			.teamultimate-four-<?php echo $postid;?> .single-teamultimate-items-<?php echo $postid;?>:hover::before {
			    opacity: 0.7;
			}
			.teamultimate-four-<?php echo $postid;?> .single-teamultimate-thumb{
				overflow: hidden;
				position: relative;
			}
			.teamultimate-four-<?php echo $postid;?> .single-teamultimate-info {
			    bottom: 50px;
			    left: 22px;
			    opacity: 0;
			    position: absolute;
			...
			.teamultimate-four-<?php echo $postid;?> .single-teamultimate-items-<?php echo $postid;?>:hover .single-teamultimate-info {
			    opacity: 1;
			    bottom:25px;
			}
			.teamultimate-four-<?php echo $postid;?> .single-teamultimate-title h2 {
			    margin: 0;
			    padding: 0;
			...
			.teamultimate-four-<?php echo $postid;?> .single-teamultimate-designation h3 {
			    margin: 0;
			    padding: 0;
			...
			.teamultimate-four-<?php echo $postid;?> .single-teamultimate-email h4 {
			    margin: 0;
			    padding: 0;
			...
			.teamultimate-four-<?php echo $postid;?> .single-teamultimate-numbers p {
			    margin: 0;
			    padding: 0;
			...
			.teamultimate-four-<?php echo $postid;?> .single-teamultimate-description p {
			    margin: 0;
			    padding: 0;
			...
			.teamultimate-four-<?php echo $postid;?> .single-teamultimate-location p {
			    margin: 0;
			    padding: 0;
			...
			.teamultimate-four-<?php echo $postid;?> .single-teamultimate-socialprofiles {
				margin-top:20px;
			}
			.teamultimate-four-<?php echo $postid;?> .single-teamultimate-socialprofiles ul {
			    margin: 0;
			    padding: 0;
			    list-style: none;
			}
			.teamultimate-four-<?php echo $postid;?> .single-teamultimate-socialprofiles ul li a {
			...
			.teamultimate-four-<?php echo $postid;?> .single-teamultimate-socialprofiles ul li a:visited {
			    color: <?php echo $pe_team_socialicon_color;?>;
			    text-decoration: none;
			    box-shadow: none;
			    outline: none;
			...
			.teamultimate-four-<?php echo $postid;?> .single-teamultimate-thumb img {
			    box-shadow: none;
			    border-radius: 0;
			...
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-lg-1,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-lg-2,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-lg-3,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-lg-4,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-lg-5,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-lg-6,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-md-1,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-md-2,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-md-3,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-md-4,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-md-5,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-md-6,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-sm-1,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-sm-2,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-sm-3,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-sm-4,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-sm-5,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-sm-6,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-xs-1,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-xs-2,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-xs-3,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-xs-4,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-xs-5,
			.teamultimate-four-<?php echo $postid;?> .teamcolumn-col-xs-6 {
				float: left;
			...
			<?php if( $pe_team_social_style == 1 ){ ?>
				.teamultimate-four-<?php echo $postid;?> .single-teamultimate-socialprofiles ul li {
				    list-style: none;
		...
		<div class="teamultimate-four-<?php echo $postid;?>">
			<?php
